...
/************************** CONFIG SECTION **************************/
var s_account="rakutenblogplazadev"
var s=s_gi(s_account)
s.charSet="EUC-JP"
s.cookieDomainPeriods="3"
s.dynamicAccountSelection=true
s.dynamicAccountList="rakutenblogplazamain=plaza.rakuten.co.jp"
/* E-commerce Config */
s.currencyCode="JPY"
...
s.linkInternalFilters="javascript:,plaza.rakuten.co.jp"
...
function s_doPlugins(s){
	...
	//linkHandler
	var url=s.linkHandler("hb.afl.rakuten.co.jp|pt.afl.rakuten.co.jp|event.rakuten.co.jp|ranking.rakuten.co.jp|/item.rakuten.co.jp|www.rakuten.co.jp|directory.rakuten.co.jp")
	if(url){
		s.linkTrackVars="events,eVar45,eVar48,eVar49,prop50"
		s.linkTrackEvents="event2"
		s.events="event2"
		s.prop50="blog"
		s.eVar49=s.prop50+":"+"link_click"
		...
		if(url.indexOf(".afl.rakuten.co.jp/hgc/")>0&&url.indexOf("%3a%2f%2fitem.rakuten.co.jp")>0){
			s.eVar45=s.eVar48="blog:affiliate-link-diary"
			s.prop50="ichiba"
		}else if(url.match(/_RTblog/)){
			s.eVar45=s.eVar48="blog:unknown"
			s.prop50="affiliate"
			...
			s.eVar45=s.eVar48="blog:direct-link"
			s.prop50="ichiba"
		}else{
			s.eVar45=s.eVar48="blog:unknown"
			s.prop50="affiliate"
...
/************************** PLUGINS SECTION *************************/
/*
 * Plugin: gClick 0.4_blog - Custom Link for Rakuten global
 */
s.gclick=new Function("to","nm",""
+"if(!s.prop50)s.prop50='blog';"
...
+"from+'_'+nm;s.prop50=to;s.tl(this,'o')");
