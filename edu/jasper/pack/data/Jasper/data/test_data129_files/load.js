...
// レイヤーを書き出す
function Wrt(){
	document.write('<a href="javascript:;" onClick="Tag(\'[太字]\',\'[/太字]\',\'太字の文\');return false;" title="太字の文が入ります。"><img src="http://blog-imgs-1.fc2.com/image/icon_main/comment_editor/bold.png" alt="太字の文が入ります。" width="20" height="20" style="border:0;"></a>&nbsp;');
	document.write('<a href="javascript:;" onClick="Tag(\'[斜体]\',\'[/斜体]\',\'斜体の文\');return false;" title="斜体の文が入ります。"><img src="http://blog-imgs-1.fc2.com/image/icon_main/comment_editor/italic.png" alt="斜体の文が入ります。" width="20" height="20" style="border:0;"></a>&nbsp');
	document.write('<a href="javascript:;" onClick="Tag(\'[下線]\',\'[/下線]\',\'下線の文\');return false;" title="下線の文が入ります。"><img src="http://blog-imgs-1.fc2.com/image/icon_main/comment_editor/underline.png" alt="下線の文が入ります。" width="20" height="20" style="border:0;"></a>&nbsp');
	document.write('<a href="javascript:;" onClick="Tag(\'[打消]\',\'[/打消]\',\'打ち消しの文\');return false;" title="打ち消しの文が入ります。"><img src="http://blog-imgs-1.fc2.com/image/icon_main/comment_editor/strikethrough.png" alt="打ち消しの文が入ります。" width="20" height="20" style="border:0;"></a>&nbsp');
	document.write('<a href="javascript:;" onClick="ColorP();return false;" title="色付きの文が入ります。"><img src="http://blog-imgs-1.fc2.com/image/icon_main/comment_editor/color.png" alt="色付きの文が入ります。" width="20" height="20" style="border:0;" id="button_color"></a>&nbsp;');
	document.write('<a href="javascript:;" onClick="Icon();return false;" title="絵文字を挿入します。"><img src="http://blog-imgs-1.fc2.com/image/icon_main/comment_editor/emoji.png" alt="絵文字を挿入します。" width="20" height="20" style="border:0;" id="button_icon"></a>&nbsp');
}
