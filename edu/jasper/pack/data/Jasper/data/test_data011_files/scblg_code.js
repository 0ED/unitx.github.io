...
/************************** CONFIG SECTION **************************/
var s_account="rakutenblogplazauserdev"
var scblg=s_gi(s_account)
scblg.charSet="EUC-JP"
scblg.cookieDomainPeriods="3"
scblg.dynamicAccountSelection=true
scblg.dynamicAccountList="rakutenblogplazausermain=plaza.rakuten.co.jp"
/* E-commerce Config */
scblg.currencyCode="JPY"
/* Link Tracking Config */
scblg.trackDownloadLinks=false
scblg.trackExternalLinks=false
scblg.trackInlineStats=true
scblg.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx"
scblg.linkInternalFilters="javascript:,plaza.rakuten.co.jp"
scblg.linkLeaveQueryString=true
scblg.linkTrackVars="None"
scblg.linkTrackEvents="None"

/* Plugin Config */
scblg.usePlugins=true

/* Page Name Plugin Config */
scblg.siteID=""
scblg.defaultPage=""
scblg.queryVarsList=""
scblg.pathExcludeDelim=";"
scblg.pathConcatDelim=":"
scblg.pathExcludeList=""

function scblg_doPlugins(scblg) {
	//tracking code
	scblg.campaign=scblg.getQueryParam("scid,sclid",":")
	//page name
	if(!scblg.pageType&&!scblg.pageName){
		scblg.pageName=scblg.getPageName().toLowerCase()
		if(!scblg.pageName)scblg.pageName="top"
		scblg.pageName=scblg.pageName.replace(/\.[a-z]+$/,"")
		scblg.pageName=scblg.pageName.replace(":index","")
	}
	//channel
	if(!scblg.channel)scblg.channel=scblg.pageName.split(":")[0]
	//linkHandler
	var url=scblg.linkHandler("hb.afl.rakuten.co.jp|pt.afl.rakuten.co.jp|event.rakuten.co.jp|ranking.rakuten.co.jp|/item.rakuten.co.jp|www.rakuten.co.jp|directory.rakuten.co.jp")
	if(url){
		scblg.linkTrackVars="events,eVar16"
		scblg.linkTrackEvents="event2"
		scblg.events="event2"
		if(url.indexOf(".afl.rakuten.co.jp/hgc/")>0&&url.indexOf("%3a%2f%2fitem.rakuten.co.jp")>0){
			scblg.eVar16="affiliate-link-diary"
		}else if(url.match(/_RTblog/)){
			scblg.eVar16="affiliate:unknown"
		}else if(url.match(/event.rakuten.co/)||url.match(/\/item.rakuten.co/)||url.match(/www.rakuten.co/)||url.match(/ranking.rakuten.co/)||url.match(/directory.rakuten.co/)){
			scblg.eVar16="direct-link"
		}else{
			scblg.eVar16=scblg.eVar48="unknown"
		}
	}
	//getTimeParting
	try{
		scblg.prop28=scblg.eVar28=scblg.getTimeParting("h")
		scblg.prop29=scblg.eVar29=scblg.getTimeParting("d")+scblg.getTimeParting("h")
	}catch(e){}
}

scblg.doPlugins=scblg_doPlugins
/************************** PLUGINS SECTION *************************/
/*
 * Plugin: getPageName v2.1 - parse URL and return
 */
scblg.getPageName=new Function("u",""
 ...
 */
scblg.linkHandler=new Function("p","t",""
+"var s=this,h=s.p_gh(),i,l;t=t?t:'o';if(!h||(s.linkType&&(h||s.linkN"
+"ame)))return '';i=h.indexOf('?');h=s.linkLeaveQueryString||i<0?h:h."
+"substring(0,i);l=s.pt(p,'|','p_gn',h.toLowerCase());if(l){s.linkNam"
+"e=l=='[['?'':l;s.linkType=t;return h;}return '';");
scblg.p_gn=new Function("t","h",""
+"var i=t?t.indexOf('~'):-1,n,x;if(t&&h){n=i<0?'':t.substring(0,i);x="
+"t.substring(i+1);if(h.indexOf(x.toLowerCase())>-1)return n?n:'[[';}"
+"return 0;");

/*
 * Plugin: getTimeParting 1.5r - Set timeparting values based on time zone
 * DST disabled
 */
scblg.getTimeParting=new Function("t",""
 ...
 */
scblg.getQueryParam=new Function("p","d","u",""
+"var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.locati"
+"on);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=s.p_gpv(p.substring(0,i),u+'');if(t){t=t.indexOf('#')>-"
+"1?t.substring(0,t.indexOf('#')):t;}if(t)v+=v?d+t:t;p=p.substring(i="
+"=p.length?i:i+1)}return v");
scblg.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
scblg.p_gvf=new Function("t","k",""
 ...
 */
if(!scblg.__ccucr){scblg.c_rr=scblg.c_r;scblg.__ccucr = true;
scblg.c_r=new Function("k",""
 ...
 */
if(!scblg.__ccucw){scblg.c_wr=scblg.c_w;scblg.__ccucw = true;
scblg.c_w=new Function("k","v","e",""
+"this.new2 = true;"
...
scblg.visitorNamespace="rakuten";scblg.dc=112;
