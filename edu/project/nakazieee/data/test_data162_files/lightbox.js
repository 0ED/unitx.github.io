...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/common/images/lightbox_ic_loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/common/images/lightbox_bt_prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/common/images/lightbox_bt_next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'/common/images/lightbox_bt_close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'/common/images/lightbox_blank.gif',			// (string) Path and the name of a blank image (one pixel)
			// Configuration related to container image box
			containerBorderSize:	10,			// (integer) If you adjust the padding in the CSS for the container, #lightbox-container-image-box, you will need to update this value
			containerResizeSpeed:	400,		// (integer) Specify the resize duration of container image. These number are miliseconds. 400 is default.
			// Configuration related to texts in caption. For example: Image 2 of 8. You can alter either "Image" and "of" texts.
			txtImage:				'フォトギャラリー　',	// (string) Specify text "Image"
