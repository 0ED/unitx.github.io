...
Ten.Browser = {
    ...
    isIPhone : (navigator.userAgent.indexOf('iPod;') != -1 || navigator.userAgent.indexOf('iPhone;') != -1),
...
Ten.Browser.isTouch = Ten.Browser.isIPhone || Ten.Browser.isAndroid || Ten.Browser.isDSi;
...
Hatena.Star.Pallet = new Ten.Class({
    ...
    showPallet: function(pos, addButton) {
        ...
        this.container.innerHTML = '<iframe id="' + Hatena.Star.Pallet.PALLET_ELEMENT_ID + '" src="' + 
            Hatena.Star.BaseURL + 'colorpalette?uri=' + encodeURIComponent(this.addButton.entry.uri) + '&location=' + encodeURIComponent(document.location.href) +
...
try {
(function () {
    var april_fool_start = new Date('2010/04/01 00:00:00');
    var april_fool_end = new Date('2010/04/02 00:00:00');
    var now = new Date();
    if (april_fool_start < now && now < april_fool_end) {
        Hatena.Star.Star.ColorPallet.yellow.ImgSrc = Hatena.Star.BaseURL + 'images/april2010/star.gif';
        Hatena.Star.Star.ColorPallet.green.ImgSrc  = Hatena.Star.BaseURL + 'images/april2010/star-green.gif';
        Hatena.Star.Star.ColorPallet.red.ImgSrc    = Hatena.Star.BaseURL + 'images/april2010/star-red.gif';
        Hatena.Star.Star.ColorPallet.blue.ImgSrc   = Hatena.Star.BaseURL + 'images/april2010/star-blue.gif';
        Hatena.Star.Star.ColorPallet.purple.ImgSrc = Hatena.Star.BaseURL + 'images/april2010/star-purple.gif';
        Hatena.Star.Star.ColorPallet.temp.ImgSrc   = Hatena.Star.BaseURL + 'images/star-temp.gif';
    }
})()
} catch (e) {}
