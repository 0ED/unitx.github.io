...
//	Configuration
//
var fileLoadingImage = "/inc/images/lb/loading.gif";		
var fileBottomNavCloseImage = "/inc/images/lb/closelabel.gif";
var fileBottomNavPrintImage = "/inc/images/lb/print.gif";
...
Lightbox.prototype = {
	...
	initialize: function() {	
		...
		objBottomNavPrintLink.onclick = function() { myLightbox.printImg();printSW = false; return false; }
	...
	printImg: function() {
		aa = window.open('','uu');
		aa.document.write("<img src='"+ imageArray[activeImage][0] + "' onload='window.opener.printMe()'><script>print();</script>");
		printWin = aa;
		//setInterval(function(){aa.print();},2000);
	},
