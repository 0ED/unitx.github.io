...
ajax.prototype = {
  ...
  request: function(url){
    ...
    if (this.method == 'post') {
      this.transport.setRequestHeader('Content-type', 'application/x-www-form-urlencoded;charset=Shift_JIS');
//      this.transport.setRequestHeader('Content-type', 'txt/html;charset=gb2312');
...
//        setTimeout(function(){this.update.innerHTML =  this.transport.responseText;}.bind(this), 10);
        setTimeout(function(){this.update.innerHTML =  "タグが保存されました。ページをリロードすると表示されます。保存したタグを確認するには、Myページのタグを確認してください。";}.bind(this), 10);
     }
